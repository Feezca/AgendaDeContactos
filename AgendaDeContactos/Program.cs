...
namespace AgendaDeContactos
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //esta configuracion generalmente va en un archivo aparte,en este caso esta en el appsettings.json,que es una instancia
            //local, se pueden generar diferentes instancias.
